...
export const metadata: Metadata = {
  ...
  description: "Profesjonalny druk 3D, inteligentne wizytówki NFC, breloki zbliżeniowe i gadżety reklamowe. Sprawdź naszą ofertę druku 3D na zamówienie!",
  keywords: ["druk 3d", "wizytówki nfc", "gadżety reklamowe", "breloki nfc", "druk na zamówienie", "maikel drukuje"],
